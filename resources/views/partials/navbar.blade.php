<nav class="navbar navbar-expand-lg ">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 end">
        <li><a class="nav-link" dusk="cart" href="/cart"><i class="m-0" aria-controls="offcanvasRight" data-feather="shopping-cart"></i></a></li>
        <li><a class="nav-link" href="/"><i class="m-0" data-feather="user"></i></a></li>
        @auth
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" dusk="userDropdown">Welcome back, {{ auth()->user()->username }}</a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#staticBackdrop" href="#" dusk="logoutLink">Logout</a></li>
          </ul>
        </li>
        @else
        <li class="nav-item"><a href="/login" class="nav-link {{ ($title === 'Login') ? 'active' : '' }}"><i class="bi bi-box-arrow-in-right"></i> Login</a></li>
        @endauth
      </ul>
    </div>
  </div>
