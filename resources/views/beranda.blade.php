                            ...
                            <div class="love">
                                @if($user->favorite->contains('menu_id', $favorite->menu->id))
                                    <form action="{{ route('destroyMenu', $favorite->menu->id) }}" method='POST'>
                                        ...
                                        <button type="submit" class="px-0 rounded" style="background-color: transparent; border: none; padding: 0; margin=0;"> 
                                ...
                                @else
                                    <form action='{{ route('storeMenu', $favorite->menu->id) }}' method='POST'>
                                        @csrf
                                        <input type="hidden" value="{{ $favorite->menu->id }}" name="menu_id">
                                        <button type="submit" class="px-2 rounded" style="background-color: transparent; border: none; padding: 0;"> 
