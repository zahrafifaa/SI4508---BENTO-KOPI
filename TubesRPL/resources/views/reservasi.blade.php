...
<body>
    <h1>Reservasi<h1>
        ...
        <input type="date" id="reservationdate" name="reservationdate" value=""><br>
        <label for="reservationtime">Waktu Reservasi</label>
        <input type="time" id="reservationtime" name="reservationtime" value=""><br>
        <label for="numofvisitor">Jumlah Pengunjung : </label>
        <input type="integer" id="numofvisitor" name="numofvisitor" value=""><br>
</body>
</html>